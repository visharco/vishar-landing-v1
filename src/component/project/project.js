...
class Project extends Component {
    ...
    render() {
        return (
            <div   className={"project " + this.props.data.status} 
            // onClick={this.props.showProject} 
            onClick={() => this.showProject(this.props.data.id)}
            >
                ...
                <div className="p-right" >
                    <div className="p-right-title" >
                        <div className="p-right-text" >
                            ...
                            <p>
                                {this.props.data.desc.substring(0,100)} . . .
                            </p>
                        </div>
                    ...
                    <div className="image-of-project" style={{backgroundImage:'url(' +this.props.data.image + ')', backgroundSize: this.props.data.is_final ? '100%' : '50%'}}></div>
